...
export const AgentDebugConsole: React.FC<AgentDebugConsoleProps> = ({ 
  ...
  const fetchAgentMemory = async () => {
    ...
    try {
      ...
      addSystemLog(`Error fetching memories: ${error.message || 'Unknown error'}`);
    } finally {
  ...
  const fetchAgentInfo = async () => {
    ...
    try {
      ...
      addSystemLog(`Error fetching agent info: ${error.message || 'Unknown error'}`);
    }
  };
  ...
  const fetchAgentTools = async () => {
    ...
    try {
      ...
      addSystemLog(`Error fetching agent tools: ${error.message || 'Unknown error'}`);
    }
  };
